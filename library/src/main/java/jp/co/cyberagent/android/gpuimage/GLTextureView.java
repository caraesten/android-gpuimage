...
public class GLTextureView extends TextureView
     ...
     * super(context);
     * setEGLContextClientVersion(2); // Pick an OpenGL ES 3.0 context.
     * setRenderer(new MyRenderer());
     * }
     * </pre>
     * <p>Note: Activities which require OpenGL ES 3.0 should indicate this by
     ...
     * EGLContextFactory is responsible for creating an OpenGL ES 3.0-compatible context.
     * If
     * {@link #setEGLConfigChooser(EGLConfigChooser)} has been called, then the supplied
     * EGLConfigChooser is responsible for choosing an OpenGL ES 3.0-compatible config.
     *
